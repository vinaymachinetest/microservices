...
public class HelloWorld {
	...
	// Returning bean(java pojo class) in a json respoonse using internally calling
	// jackson api
	@GetMapping("/helloworld_v4")
	public JavaBean helloworld_v4() {

		return new JavaBean(
				"Hi! the is demo app converting java pojo class into json response automatically by jackson api");
	}
